    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">Mixolidio</h1>
          <p className="text-gray-400">Browser-based Digital Audio Workstation</p>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div className="text-gray-400">
            ...
            <div className="text-xs">Upload Samples</div>
          </div>
          <div className="text-gray-400">
            <div className="text-2xl mb-1">🎚️</div>
            <div className="text-xs">Mix Tracks</div>
          </div>
          <div className="text-gray-400">
            <div className="text-2xl mb-1">💾</div>
            <div className="text-xs">Save Projects</div>
          </div>
        </div>
      </div>
    </div>
